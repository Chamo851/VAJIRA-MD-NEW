...
global.owner = process.env.OWNER_NUMBER  || '94706200559' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=KclmWaDZ#mBqaqrqNI5UUc7mgUZFUqjaaw2zHI4ojBuQEs0HWImM' ,
